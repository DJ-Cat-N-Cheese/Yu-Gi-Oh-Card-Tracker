                                ...
                                if not item['candidates']:
                                    ...
                                    with ui.row().classes('w-full items-center gap-4'):
                                        ...
                                        with ui.column().classes('w-full'):
                                            ...
                                            options = {generate_variant_id(item['card_id'], c.set_code, c.set_rarity, c.image_id): f"{c.set_code} - {c.set_rarity} (Art: {c.image_id})" if c.image_id and c.image_id > 0 else f"{c.set_code} - {c.set_rarity}" for c in item['candidates']}
