                                ...
                                if not item['candidates']:
                                    ...
                                    with ui.row().classes('w-full items-center gap-4'):
                                        with ui.column().classes('w-32 flex-shrink-0'):
                                            preview_image = ui.image('').classes('w-full h-auto hidden rounded shadow-sm border border-gray-600')
                                            ...
                                            if select.value:
                                                class DummyEvent:
                                                    def __init__(self, value):
                                                        self.value = value
                                                ui.timer(0.1, lambda s=select.value, ev=DummyEvent, f=on_change: f(ev(s)), once=True)
